...
class Server {
    constructor() {
        ...
        this.channel = '📌・sobre_el_servidor';
    ...
    runCommand(args, msgObject, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (args.length > 0) {
                 ...
                 */
                    yield msgObject.channel.send(embedRoles);
                    yield msgObject.channel.send(embedservidor1);
                    yield msgObject.channel.send(embedservidor2);
                }
            }
        });
    }
