...
export default class Turnos implements MigBotCommand {
    ...
    private migdrplogo = new Discord.MessageAttachment(`${getHostUrl()}/img/migdrp-logo-small-red.png`, 'migdrp-icon.png');
    ...
    public async runCommand(args: string[], msgObject: Discord.Message, client: Discord.Client) {
        ...
        const filter = (reaction: Discord.MessageReaction) => reaction.emoji.name === '🎟️' || reaction.emoji.name === '⛔' || reaction.emoji.name === '✅';
