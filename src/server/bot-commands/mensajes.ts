...
export default class Mensajes implements MigBotCommand {
    ...
    private migdrplogo = new Discord.MessageAttachment(`$http://localhost:2503/img/migdrp-logo-small-red.png', 'migdrp-icon.png`);
    private migdrplogoGreen = new Discord.MessageAttachment(`http://localhost:2503/img/migdrp-logo-small-green.png', 'migdrp-icon-green.png`);
    private bonobotlogo = new Discord.MessageAttachment(`http://localhost:2503/img/LOGO_bb_dsicordback.png', 'bb-logo.png`);
